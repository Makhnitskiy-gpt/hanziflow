...
export function ExplainerIndex() {
  return (
    <div className="flex flex-col gap-4 max-w-2xl">
      ...
      {/* --- Тоны --- */}
      <ExplainerCard explainerKey="tones" title="Тоны в китайском языке">
        <div className="text-sm text-rice-muted leading-relaxed flex flex-col gap-3">
          ...
          <div className="mt-1 p-3 rounded-lg bg-ink-elevated border border-ink-border">
            ...
            <ul className="text-xs text-rice-dim flex flex-col gap-1">
              <li>3+3 &rarr; 2+3: 你好 nǐhǎo &rarr; [n&iacute;hǎo]</li>
              <li>不 (b&ugrave;) перед 4-м тоном &rarr; b&uacute;: 不是 &rarr; [b&uacute;sh&igrave;]</li>
              <li>一 (yī) &rarr; y&iacute; перед 4-м, y&igrave; перед 1/2/3-м</li>
            </ul>
          </div>
        </div>
      </ExplainerCard>
      ...
      {/* --- Пиньинь --- */}
      <ExplainerCard explainerKey="pinyin" title="Пиньинь — латинская транскрипция">
        <div className="text-sm text-rice-muted leading-relaxed flex flex-col gap-3">
          <p>
          ...
          <div className="p-3 rounded-lg bg-ink-elevated border border-ink-border">
            ...
            <ul className="text-xs text-rice-dim flex flex-col gap-1.5">
              ...
              <li><strong className="text-rice-muted">-i после zh/ch/sh/r</strong> — не «и», а «ы» с загнутым языком: shi &asymp; шы</li>
            </ul>
          </div>
      ...
      {/* --- Порядок черт --- */}
      <ExplainerCard explainerKey="stroke_order" title="Порядок штрихов">
        <div className="text-sm text-rice-muted leading-relaxed flex flex-col gap-3">
          <p>
      ...
      {/* --- Типы построения --- */}
      <ExplainerCard explainerKey="formation_types" title="Типы построения иероглифов">
        <div className="text-sm text-rice-muted leading-relaxed flex flex-col gap-3">
          <p>
      ...
      {/* --- SRS --- */}
      <ExplainerCard explainerKey="srs" title="Интервальное повторение (SRS)">
        <div className="text-sm text-rice-muted leading-relaxed flex flex-col gap-3">
          <p>
          ...
          <p>
            <strong className="text-rice">Как добавить карточку:</strong> откройте радикал или иероглиф
            и нажмите кнопку «Добавить в повторение». Карточки не создаются автоматически —
            вы сами решаете, что учить.
          </p>
        </div>
      </ExplainerCard>

      {/* --- Счётные слова --- */}
      <ExplainerCard explainerKey="classifiers" title="Счётные слова (классификаторы)">
        <div className="text-sm text-rice-muted leading-relaxed flex flex-col gap-3">
          <p>
          ...
          <div className="p-3 rounded-lg bg-ink-elevated border border-ink-border">
            ...
            <ul className="text-xs text-rice-dim flex flex-col gap-1">
              <li><strong className="text-rice-muted">个 (g&egrave;)</strong> — универсальный, для людей и предметов</li>
              ...
              <li><strong className="text-rice-muted">块 (ku&agrave;i)</strong> — для кусков и юаней</li>
      ...
      {/* --- Мнемоники --- */}
      <ExplainerCard explainerKey="mnemonics" title="Мнемоники — рисуй, чтобы запомнить">
        <div className="text-sm text-rice-muted leading-relaxed flex flex-col gap-3">
          <p>
            Правая панель приложения — мнемонический холст. Рисуйте стилусом (или мышкой)
            ассоциации, которые помогут запомнить иероглиф. Рисунки сохраняются для каждого
            радикала и иероглифа отдельно.
          </p>
          <p>
